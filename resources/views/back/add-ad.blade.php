            ...
            <form action="{{ route('back.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" id="title" name="title" class="form-control" placeholder="Ad Title" onkeyup="generateSlug()" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Meta Tag (Slug)</label>
                        <input type="text" id="slug" name="slug" class="form-control" readonly placeholder="Auto-generated">
                    </div>
                </div>
